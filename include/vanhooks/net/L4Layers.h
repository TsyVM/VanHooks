...
// ===== Consolidated header: L4Layers.h =====
// Merges: TcpLayer, UdpLayer
...
#define VH_DEPRECATED_TCP_OPTION_TYPE                                                                                \
	VH_DEPRECATED("enum TcpOptionType is deprecated; Use enum class TcpOptionEnumType instead")
...
#pragma pack(pop)
	...
	enum TcpOptionType : uint8_t
	{
		...
		/** SACK Block */
		VH_TCPOPT_SACK = 5,
		/** Echo (obsoleted by option TcpOptionType::VH_TCPOPT_TIMESTAMP) */
		TCPOPT_ECHO = 6,
		/** Echo Reply (obsoleted by option TcpOptionType::VH_TCPOPT_TIMESTAMP) */
		TCPOPT_ECHOREPLY = 7,
		/** TCP Timestamps */
		VH_TCPOPT_TIMESTAMP = 8,
		/** CC (obsolete) */
		TCPOPT_CC = 11,
		/** CC.NEW (obsolete) */
		TCPOPT_CCNEW = 12,
	...
	/** vanhooks::net::TcpOptionEnumType::Nop length */
#define VH_TCPOLEN_NOP 1
	/** vanhooks::net::TcpOptionEnumType::Eol length */
#define VH_TCPOLEN_EOL 1
	/** vanhooks::net::TcpOptionEnumType::Mss length */
#define VH_TCPOLEN_MSS 4
	/** vanhooks::net::TcpOptionEnumType::Window length */
#define VH_TCPOLEN_WINDOW 3
	/** vanhooks::net::TcpOptionEnumType::SackPerm length */
#define VH_TCPOLEN_SACK_PERM 2
	/** vanhooks::net::TcpOptionEnumType::Sack length */
#define VH_TCPOLEN_SACK_MIN 2
	/** vanhooks::net::TcpOptionEnumType::Echo length */
#define VH_TCPOLEN_ECHO 6
	/** vanhooks::net::TcpOptionEnumType::EchoReply length */
#define VH_TCPOLEN_ECHOREPLY 6
	/** vanhooks::net::TcpOptionEnumType::Timestamp length */
#define VH_TCPOLEN_TIMESTAMP 10
	/** vanhooks::net::TcpOptionEnumType::Cc length */
#define VH_TCPOLEN_CC 6
	/** vanhooks::net::TcpOptionEnumType::CcNew length */
#define VH_TCPOLEN_CCNEW 6
	/** vanhooks::net::TcpOptionEnumType::CcEcho length */
#define VH_TCPOLEN_CCECHO 6
	/** vanhooks::net::TcpOptionEnumType::Md5 length */
#define VH_TCPOLEN_MD5 18
	/** vanhooks::net::TcpOptionEnumType::MpTcp length */
#define VH_TCPOLEN_MPTCP_MIN 8
	/** vanhooks::net::TcpOptionEnumType::Scps length */
#define VH_TCPOLEN_SCPS 4
	/** vanhooks::net::TcpOptionEnumType::Snack length */
#define VH_TCPOLEN_SNACK 6
	/** vanhooks::net::TcpOptionEnumType::RecBound length */
#define VH_TCPOLEN_RECBOUND 2
	/** vanhooks::net::TcpOptionEnumType::CorrExp length */
#define VH_TCPOLEN_CORREXP 2
	/** vanhooks::net::TcpOptionEnumType::Qs length */
#define VH_TCPOLEN_QS 8
	/** vanhooks::net::TcpOptionEnumType::UserTo length */
#define VH_TCPOLEN_USER_TO 4
	/** vanhooks::net::TcpOptionEnumType::RvbdProbe length */
#define VH_TCPOLEN_RVBD_PROBE_MIN 3
	/** vanhooks::net::TcpOptionEnumType::RvbdTrpy length */
#define VH_TCPOLEN_RVBD_TRPY_MIN 16
	/** vanhooks::net::TcpOptionEnumType::ExpFd and vanhooks::net::TcpOptionEnumType::ExpFe length */
#define VH_TCPOLEN_EXP_MIN 2
	...
	public:
		 ...
		 */
		VH_DEPRECATED("Use getTcpOptionEnumType instead")
		...
		/**
		 * @return TCP option type casted as vanhooks::net::TcpOptionEnumType enum. If the data is null a value
	...
	public:
		 ...
		 */
		VH_DEPRECATED("enum NopEolOptionTypes is deprecated; Use enum class NopEolOptionEnumType instead")
	...
	public:
		 ...
		 */
		VH_DEPRECATED("Use insertTcpOptionAfter instead")
...
#undef VH_DEPRECATED_TCP_OPTION_TYPE
// ---- end TcpLayer.h ----
